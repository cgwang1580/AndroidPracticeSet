...
public class TransitionActivity extends AppCompatActivity {
    ...
    private void initUI () {
        ...
        mImageViewCam.setBackground(getDrawable(R.drawable.picture_9_16));
    ...
    private void doScreenChange (int screenRatio, int srcWidth, int srcHeight, int dstWidth, int dstHeight) {
        ...
        ConstraintLayout rootLayout1 = findViewById(R.id.transition_root);
        newSet.clone(rootLayout1);

        findViewById(R.id.image_view_preview).setVisibility(View.INVISIBLE);
        TransitionSet transitionSet = new TransitionSet();
        Transition transition = new ChangeBounds();
        transition.excludeTarget(R.id.image_view_preview, true);
        Fade fade = new Fade();
        transitionSet.addTransition(fade).addTransition(transition);
        transitionSet.setDuration(1000);
        TransitionManager.beginDelayedTransition(rootLayout1, transitionSet);
    ...
    private void updateRenderSize (int screenRatio, int srcWidth, int srcHeight, int dstWidth, int dstHeight) {
        ...
        ConstraintLayout rootLayout = findViewById(R.id.transition_root);
